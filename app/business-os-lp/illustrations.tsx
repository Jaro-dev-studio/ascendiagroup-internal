...
// Illustration 1: Under Construction - Breaking Building
export function UnderConstructionIllustration() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Animate the falling/construction pieces
      gsap.to(".falling-piece", {
        y: 10,
        rotation: 5,
        duration: 2,
        ease: "power1.inOut",
      ...
      // Pulse the main structure
      gsap.to(".main-structure", {
        scale: 1.02,
      ...
      // Shake effect on construction elements
      gsap.to(".shake-element", {
        x: 2,
        duration: 0.1,
        ease: "power1.inOut",
        yoyo: true,
  ...
  return (
    ...
    >
      ...
      {/* Trees/Foliage - Right side */}
      <g className="foliage" opacity="0.2">
        ...
        <path d="M646.47,564.55a49.66,49.66,0,0,1-3.8-6l28.26-3.73-30.42-.73a51.38,51.38,0,0,1,.31-40.64l40.12,22.45-36.75-28.84a51.28,51.28,0,1,1,82.84,60,50.8,50.8,0,0,1,5.55,9.53l-37.09,17.8,39.33-11.83A51.34,51.34,0,0,1,725,630.47a51.28,51.28,0,1,1-80.56-2.54,51.28,51.28,0,0,1,2-63.38Z" transform="translate(-11.09 -87.76)" fill="#0BA5E9"/>
      ...
      {/* Main construction structure - beams */}
      <g className="main-structure">
        <polygon className="shake-element" points="157.82 676.73 168.31 676.7 183.1 676.7 201.8 372.92 386.99 63.89 378.94 55.25 378.94 33.37 178.66 365.76 157.82 676.73" fill="#f1c0c0"/>
        ...
        <polygon className="shake-element" points="378.88 54.84 590.43 281.9 583.89 681.3 601.86 683.47 602.16 683.51 620.13 683.51 622.28 299.05 1018.41 431.37 1025.09 666.97 1039.55 668.59 1044.45 669.14 1033.11 415.03 619.01 269.65 391.95 33.6 378.88 33.6 378.88 54.84" fill="#f1c0c0"/>
        ...
        {/* Cross beam */}
        <polygon className="falling-piece" points="621.42 451.99 766.71 480.6 766.76 480.61 1021.23 530.74 1032.88 526.07 1032.84 525.25 1032.08 509 621.57 426.05 621.42 451.99" fill="#f1c0c0"/>
      ...
      {/* Horizontal beam */}
      <polygon className="shake-element" points="588.91 358.04 588.91 367.89 420.24 400.79 411.49 406.09 381.3 406.09 381.3 400.54 547.02 360.5 588.91 358.04" fill="#f1c0c0"/>
      <polygon points="588.91 367.89 420.24 400.79 411.49 406.09 381.3 406.09 548.25 370.36 588.91 367.89" opacity="0.1"/>
    </svg>
  );
}

// Placeholder components for other slides - to be replaced with actual SVGs
export function PlaceholderIllustration({ title }: { title: string }) {
  return (
    <div className="flex size-full items-center justify-center rounded-lg border border-dashed border-neutral-700 bg-neutral-900/50">
