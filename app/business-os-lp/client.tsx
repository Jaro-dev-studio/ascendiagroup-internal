...
import { PainPointsCarousel } from "@/app/business-os-lp/pain-point-illustrations";
...
export default function BusinessOSClient({
  ...
  // Show content after typewriter completes (faster on mobile since no typewriter)
  useEffect(() => {
  ...
  // Track when ROI calculator CTA button is visible
  useEffect(() => {
    ...
    // Wait for the calculator to render, then observe the CTA button
    const checkForCTA = () => {
    ...
    // Check immediately and also after a short delay for dynamic content
    checkForCTA();
  ...
  // Show floating CTA after scrolling past hero, but hide when calculator CTA is visible
  useEffect(() => {
    const handleScroll = () => {
    ...
    handleScroll(); // Check immediately when calculatorCTAVisible changes
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6 pt-24">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          {/* Subtle grid pattern - visible on all screens */}
          <div 
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          >
            {/* Mobile: plain text, Desktop: typewriter */}
          ...
          >
            The custom-built platform that{" "}
            <span className="font-semibold text-neutral-900">automates your operations</span>{" "}
            and runs your business while you sleep.
          </motion.p>
          ...
          >
            For businesses ready to eliminate chaos and scale.
          </motion.p>
          ...
          <div className="mb-16 text-center">
            ...
            <AnimatedSection delay={0.2}>
              <p className="mx-auto mt-8 max-w-xl text-lg text-neutral-500">
                Businesses, do these sound familiar?
              </p>
            </AnimatedSection>
          </div>
